...
export class ContactFormContainerComponent {
  ...
  public id!: number;
  constructor(
    private contactHttpServices: ContactManageService,
  ...
  /**
   * Add Contact Details in Json-server using contactHttpServices
   * @param contact
   */
  public createContact(contact: Contact) {
    this.contactHttpServices
      .addContact(contact)
  ...
  /**
   * Edit contact Details in json server  using contactHttpServices
   * @param contact
   */
  public editContact(contact: Contact) {
    this.contactHttpServices
      .update(contact, this.id)
